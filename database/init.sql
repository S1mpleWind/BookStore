...
(
    ...
    sales       int          null,
    inventory   int          default 100 null,
...
insert into book(author, cover, description, price, title, sales, inventory, publisher, isbn)
values ('[英] 乔治·奥威尔',
        ...
        2800, '1984', 0, 50, '北京十月文艺出版社', '978-7-5302-1015-3'),
       ('[美] Stanley B. Lippman / [美] Josée Lajoie / [美]',
        'https://img3m5.ddimg.cn/18/16/11186350875-1_u_1.jpg',
        '这本久负盛名的 C++ 经典教程，时隔八年之久，终迎来史无前例的重大升级。除令全球无数程序员从中受益，甚至为之迷醉的——C++ 大师 Stanley B. Lippman 的丰富实践经验，C++标准委员会原负责人 Josée Lajoie 对C++标准的深入理解，以及C+ + 先驱 Barbara E. Moo 在 C++教学方面的真知灼见外，更是基于全新的 C++11标准进行了全面而彻底的内容更新。非常难能可贵的是，本书所有示例均全部采用 C++11 标准改写，这在经典升级版中极其罕见——充分体现了 C++ 语言的重大进展及其全面实践。',
        12800, 'C++ Primer 中文版（第 5 版）', 0, 30, '电子工业出版社', '978-7-121-15535-2'),
       ('[美] 凯·S.霍斯特曼（Cay S.Horstmann）',
        ...
        14900, 'Java核心技术·卷I（原书第12版）', 0, 40, '机械工业出版社', '978-7-111-55832-4'),
       ('[美]粱勇（Y.Daniel Liang）',
        ...
        8500, 'Java语言程序设计（基础篇 原书第10版）', 0, 35, '机械工业出版社', '978-7-111-54328-3'),
       ('任洪彩', 'https://img3m9.ddimg.cn/21/0/28986429-1_u_6.jpg',
        ...
        10800, 'Go专家编程', 0, 25, '机械工业出版社', '978-7-111-63240-5'),
       ('白明', 'https://img3m0.ddimg.cn/9/24/29352420-1_u_7.jpg',
        ...
        9900, 'Go语言精进之路', 0, 20, '电子工业出版社', '978-7-121-38990-2'),
       ('nagano',
...
本書同樣收錄了在這裡才看得到的特別繪製故事哦！',
        6600, '吉伊卡哇 這又小又可愛的傢伙 2', 0, 45, '台灣角川', '978-626-353-952-5'),
       ('nagano',
...
又一個「nagano WORLD」，在此拉開序幕！',
        6600, '吉伊卡哇 這又小又可愛的傢伙 1', 0, 50, '台灣角川', '978-626-353-868-9'),
...
本书同样收录了只有在这里才看得到的特别绘制故事哦！', 6600, '吉伊卡哇 這又小又可愛的傢伙 3', 0, 40, '台灣角川', '978-626-353-999-0'),
...
本书也收录了在这裡才看得到的特别绘制故事！', 6600, '吉伊卡哇 這又小又可愛的傢伙 4', 0, 35, '台灣角川', '978-626-362-125-3'),
       ('nagano', 'https://img3m0.ddimg.cn/96/6/11601126600-1_u_1700644428.jpg',
        ...
        6600, '吉伊卡哇 這又小又可愛的傢伙 5', 0, 30, '台灣角川', '978-626-362-291-5'),
       ('[美] Bruce Eckel', 'https://img3m0.ddimg.cn/4/24/9317290-1_u_6.jpg',
        'Java学习经典,殿堂级著作！赢得了全球程序员的广泛赞誉。',
        9940, 'Java编程思想（第4版）', 0, 28, '机械工业出版社', '978-7-111-21382-6');

insert into user(nickname, balance, email) value ('admin', 100000000, 'admin@bookstore.com');
insert into user_auth(identity, password, username, user_id, enable) value (1, 'admin', 'admin', 1, 1);